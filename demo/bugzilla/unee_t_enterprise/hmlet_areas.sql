CREATE TABLE `hmlet_areas` (
  `external_id` varchar(50) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `external_system_id` varchar(50) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `external_table` varchar(50) COLLATE utf8mb4_unicode_520_ci NOT NULL,
